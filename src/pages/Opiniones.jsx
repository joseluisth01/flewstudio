...
// Importar iconos de garantías reales
...
import totalSeguridadImg from "../assets/garantias/totalseguridad.gif";
...
export default function OpinionesPage() {
    ...
    const empresasData = [
        {
            name: "Esenzia",
            logo: null, // Logo será agregado cuando tengas las imágenes correctas
